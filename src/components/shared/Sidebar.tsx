  ...
  return (
    ...
    <aside className="w-60 h-full bg-slate-900 flex flex-col flex-shrink-0 border-r border-slate-800">
      ...
      <div className="px-3 pb-4 border-b border-slate-800">
        ...
        {clients.length === 0 ? (
          <button
            onClick={() => { router.push('/clients'); handleNavClick() }}
      ...
      <div className="px-3 pb-2">
        ...
        >
          <span className={`flex-shrink-0 ${isActive('/settings', true) ? 'text-violet-100' : 'text-slate-500 group-hover:text-slate-300'}`}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
